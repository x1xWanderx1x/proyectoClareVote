...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('id_wallet')->unique(); // Número de matrícula del alumno (id de la wallet)
            $table->string('nombres'); // Nombres del alumno
            $table->string('primer_apellido'); // Primer apellido
        ...
        Schema::create('password_reset_tokens', function (Blueprint $table) {
            $table->string('correo')->primary(); // Cambiado a 'correo' para coincidir con el campo en 'users'
            $table->string('token');
